...
public class walletDAOImp implements walletDAO {
	...
	String create_wallet = "insert into slam_wallet values(?,?)";
	...
	@Override
	public boolean Createwallet(int custid) {
		double initial_wallet_amt = 0.0;
		return jdbcTemplate.update(create_wallet, custid, initial_wallet_amt) > 0;
	}
